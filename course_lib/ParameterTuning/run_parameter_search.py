...
from course_lib.ParameterTuning.SearchSingleCase import SearchSingleCase
...
def read_data_split_and_search():
    ...
    from course_lib.Data_manager.Movielens1M.Movielens1MReader import Movielens1MReader
